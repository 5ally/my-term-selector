...
/* harmony import */ var _my_term_selector__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./my-term-selector */ "./src/my-term-selector.js");
/* jslint esnext: true */
...
(function () {
  var el = wp.element.createElement; // It's up to you on how to make this dynamic..
  ...
  function MyPostTaxesUI(OriginalComponent) {
    return function (props) {
      ...
      if (taxes.indexOf(props.slug) >= 0) {
        return el(_my_term_selector__WEBPACK_IMPORTED_MODULE_0__["default"], props);
      }
  ...
  wp.hooks.addFilter('editor.PostTaxonomyType', 'my-custom-plugin', // you should change this
  MyPostTaxesUI);
})(); // end closure
...
/* harmony import */ var _utils_terms__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./utils/terms */ "./src/utils/terms.js");
...
/*#__PURE__*/
function (_Component) {
  _babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_8___default()(HierarchicalTermSelector, _Component);

  function HierarchicalTermSelector() {
    var _this;

    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_3___default()(this, HierarchicalTermSelector);

    _this = _babel_runtime_helpers_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_5___default()(this, _babel_runtime_helpers_getPrototypeOf__WEBPACK_IMPORTED_MODULE_6___default()(HierarchicalTermSelector).apply(this, arguments));
    _this.findTerm = _this.findTerm.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_7___default()(_this));
    _this.onChange = _this.onChange.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_7___default()(_this));
    _this.onChangeFormName = _this.onChangeFormName.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_7___default()(_this));
    _this.onChangeFormParent = _this.onChangeFormParent.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_7___default()(_this));
    _this.onAddTerm = _this.onAddTerm.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_7___default()(_this));
    _this.onToggleForm = _this.onToggleForm.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_7___default()(_this));
    _this.setFilterValue = _this.setFilterValue.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_7___default()(_this));
    _this.sortBySelected = _this.sortBySelected.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_7___default()(_this));
    _this.state = {
      loading: true,
      availableTermsTree: [],
      availableTerms: [],
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_4___default()(HierarchicalTermSelector, [{
    key: "onChange",
    ...
    value: function onAddTerm(event) {
      ...
      var findOrCreatePromise = this.addRequest.catch(function (error) {
        ...
        if (errorCode === 'term_exists') {
          ...
          _this2.addRequest = _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_15___default()({
            path: Object(_wordpress_url__WEBPACK_IMPORTED_MODULE_16__["addQueryArgs"])("/wp/v2/".concat(taxonomy.rest_base), _babel_runtime_helpers_objectSpread__WEBPACK_IMPORTED_MODULE_2___default()({}, DEFAULT_QUERY, {
              parent: formParent || 0,
              search: formName
            }))
          });
      ...
      findOrCreatePromise.then(function (term) {
        ...
        var newAvailableTerms = hasTerm ? _this2.state.availableTerms : [term].concat(_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_1___default()(_this2.state.availableTerms));
    ...
    value: function getFilterMatcher(filterValue) {
      var matchTermsForFilter = function matchTermsForFilter(originalTerm) {
        ...
        var term = _babel_runtime_helpers_objectSpread__WEBPACK_IMPORTED_MODULE_2___default()({}, originalTerm); // Map and filter the children, recursive so we deal with grandchildren
    ...
    value: function render() {
      ...
      return [showFilter && Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_9__["createElement"])("label", {
        ...
        required: true
      }), taxonomy.hierarchical && !!availableTerms.length && Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_9__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_12__["TreeSelect"], {
...
}), _wordpress_components__WEBPACK_IMPORTED_MODULE_12__["withSpokenMessages"], _wordpress_compose__WEBPACK_IMPORTED_MODULE_14__["withInstanceId"]])(HierarchicalTermSelector));
...
// Based on gutenberg/packages/editor/src/utils/terms.js
...
function buildTermsTree(flatTerms) {
  ...
  var fillWithChildren = function fillWithChildren(terms) {
    return terms.map(function (term) {
      ...
      return _babel_runtime_helpers_objectSpread__WEBPACK_IMPORTED_MODULE_0___default()({}, term, {
